 ...
 * @author carmc9538
 */
public class YellowReceptacle extends Entity{
    ...
    public YellowReceptacle(int x, int y, int receptacleRoomX, int receptacleRoomY) {
        super(x, y);
        
        YellowReceptacle.roomX = receptacleRoomX;
        YellowReceptacle.roomY = receptacleRoomY;
        YellowReceptacle.x = x;
        YellowReceptacle.y = y;
